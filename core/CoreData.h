...
struct sIdentifySectorInfo
{
    ...
    // DownloadMicrocode
    bool IsDownloadCodeSupported;    // W83:0, W86:0
    bool IsTransferMode3Supported;   // W119:4, W120:4

    U16 DownloadSizeMin;             // W234 (sector unit)
    U16 DownloadSizeMax;             // W235 (sector unit)
...
typedef map<U8, U8> tThresholdMap;
